...
Проект доступен по [адресу](http://158.160.8.118/)<br>
Документация к API доступна [здесь](http://158.160.8.118/api/docs/)<br>
Админ-зона [здесь](http://158.160.8.118/admin/)<br>
- Логин: admin
- Пароль: Qwerty00
